=begin
 Windows GUI module built on win32-api module. Provides method wrappers for
 Win32 API calls.
=end
...
module WindowsGui
	...
	def self.def_api(function, parameters, return_value, rename = nil)
		api = API.new(function, parameters, return_value, 'user32') 
	...
	def_api 'GetWindowText', 'LPL', 'L'

	# int GetClassName(HWND hWnd, LPTSTR lpClassName, int nMaxCount)
	def_api 'GetClassName', 'LPL', 'L' 
